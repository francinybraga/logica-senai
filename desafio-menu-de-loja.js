...
// → Seu código aqui:
let escolha = lerTeclado.questionInt("1) Visualizar o catálogo | 2) Comprar itens do catálogo | 3) Vender itens do inventário | 4) Visualizar seus itens ")
switch(escolha){
  case 1:
  ...
  case 2:
  console.table(catalogo)
  let comprar = lerTeclado.question("O que deseja comprar?")
