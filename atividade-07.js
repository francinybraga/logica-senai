...
//     status = "Reprovado"
// }
// console.log(`De acordo com as notas do aluno, ele esta de ${status}`)
...
// let possuiIngresso = lerTeclado.keyInYN("Possui ingresso?(s/n) ")
// let idade = lerTeclado.questionInt("Digite sua idade: ")

// if (!possuiIngresso){
//     console.log(`${nome}, dirija-se à bilheteria.`)
// } else if (possuiIngresso && idade < 18) {
//     console.log("Meia-entrada: menor de idade.")
// } else if (possuiIngresso && idade >= 60) {
...
// let nome = lerTeclado.question("Digite seu nome: ")
// let idade = lerTeclado.questionInt("Digite sua idade: ")
// let possuiHab = lerTeclado.keyInYN("Possui habilitação?(s/n) ")
// let motorista = {
//     nome: nome,
//     idade: idade,
//     possuiHab: possuiHab
// }
// if(motorista.idade > 21 && motorista.possuiHab){
...
// → Seu código aqui:
// let estudante = lerTeclado.keyInYN("É estudante?(s/n)")
// let idoso = lerTeclado.keyInYN("Idade 60 ou superior?(s/n)")
// if (idoso || estudante){
...
//     notaP1: lerTeclado.questionInt("Digite a primeira nota:"),
//     notaP2: lerTeclado.questionInt("Digite a segunda nota:")
// }
...
// }
// console.table(aluno)
// console.log(`${aluno.nome}: ${situação} média: ${media}`)
...
let operacao = lerTeclado.questionFloat(`1 –${soma} | 2 –${Subtração} | 3 – ${Multiplicação} | 4 – ${divisão}`)
